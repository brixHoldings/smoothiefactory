    ...
    <MaxWidthWrapper>
      <Paper>
        ...
        <Text>
          ...
          <Super>®</Super>,” “we,” or “us”), operates a variety of websites or mobile applications, including
          smoothiefactory.com, the Smoothie Factory mobile application (“Application”), and any other site, mobile
          application, or online service where Smoothie Factory<Super>®</Super> Terms and Conditions of Use are posted
          ...
          (“Privacy Policy”). Smoothie Factory<Super>®</Super> strives to take reasonable steps to protect your personal
        ...
        <Title>
          HOW DOES Smoothie Factory<Super>®</Super> HANDLE INFORMATION FROM CHILDREN?
        </Title>
        <Text>
          Please note that Smoothie Factory<Super>®</Super> has no intention of collecting personal information from
        ...
        <Title>
          DOES Smoothie Factory<Super>®</Super> USE COOKIE TECHNOLOGY?
        </Title>
        <Text>
          Smoothie Factory<Super>®</Super> may use cookie technology to make your use of the Sites more convenient and
          to support our internal business purposes. A cookie is a piece of information that is transferred to a User’s
          ...
          <Super>®</Super> may also use cookies to help track referrals from third party web sites. Most browsers are
        ...
        <Title>
          WHAT OTHER MECHANISMS DOES Smoothie Factory<Super>®</Super> USE TO TRACK USER BEHAVIOR?
        </Title>
        <Text>
        ...
        <Text>
          Smoothie Factory<Super>®</Super> and its third party vendors may use web beacons to track and analyze
          ...
          <Super>®</Super> is owned and used by Smoothie Factory<Super>®</Super>. Smoothie Factory<Super>®</Super>{' '}
          reserves the right to publish non-personally identifiable, summary information regarding its Users for
          promotional purposes and as a representative audience for business partners.
        </Text>
        <Text>
        ...
        <Text>
          ...
          improve the products, benefits and services that Smoothie Factory<Super>®</Super>, its subsidiaries and their
        ...
        <Text>
          ...
          not subject to this Privacy Policy. The cleaned data may be published by Smoothie Factory<Super>®</Super> and
        ...
        <Text>
          ...
          the interests or safety of Smoothie Factory<Super>®</Super> or other Users.
        </Text>
        <Text>
          ...
          you may be shared with other participants in these community features. Also, Smoothie Factory<Super>®</Super>{' '}
          may make it possible for certain third party web sites to be accessed directly from our Sites and for selected
          ...
          posting to a publicly available profile page), the information provided by Smoothie Factory<Super>®</Super>{' '}
          will be visible to other users of the third party web site.
        </Text>
        <Title>
          WHEN WILL I BE CONTACTED BY Smoothie Factory<Super>®</Super>?
        </Title>
        <Text>
          You may receive products and communications associated with your transactions with Smoothie Factory
          <Super>®</Super>, such as purchases, sweepstakes and contests. You may also receive communications from
          Smoothie Factory<Super>®</Super> related to transactions that appear to be from you or which appear to be
          fraudulent. You may be contacted in regards to an issue on your account or in response to a customer service
          contact initiated by you or in response to a specific request from you such as clicking on a “forgot my
          password” link. Any administrative communications also may be accompanied by information about products and
          services, special offers and upcoming promotions or events offered by Smoothie Factory<Super>®</Super>, our
          subsidiaries and their franchisees or our marketing partners that we think may be of interest to you (“direct
          marketing”).
        </Text>
        <Text>
          You may periodically receive from Smoothie Factory<Super>®</Super>, its subsidiaries and their franchisees
          unsolicited direct marketing communications by mail (delivered via the United States Postal Service). Smoothie
          Factory<Super>®</Super> and its subsidiaries and their franchisees aspire to send standalone direct marketing
          ...
          of Receiving Direct Marketing from Smoothie Factory<Super>®</Super>?
        </Text>
        <Title>
          HOW CAN I OPT OUT OF RECEIVING DIRECT MARKETING FROM Smoothie Factory<Super>®</Super>?
        </Title>
        <Text>
          ...
          time of collection, use or disclosure, as the case may be. Smoothie Factory<Super>®</Super> is the owner of
          the personal information collected on our Sites. If you do not want your personal information to be collected,
          used or disclosed in this manner, please do not submit your personal information to us.
        </Text>
        <Text>
          If you would prefer that Smoothie Factory<Super>®</Super> not use your personal information for standalone
          direct marketing communications, subject to legal, or contractual restrictions and legal notice, you may opt
          out of such uses and/or disclosures by (a) checking the appropriate “Opt Out” box in any applicable e-mail
          ...
          Factory<Super>®</Super>. Please consult the applicable rules of the promotion or service before participating.
        ...
        <Text>
          ...
          specific information from Smoothie Factory<Super>®</Super> are not subject to an “Opt Out” process. If you
          have any suggestions on how to improve these e-mails, please let us know by using the Contact Us functionality
          on the Site. We appreciate your feedback but cannot commit to taking action.
        </Text>
        <Title>
          HOW DOES Smoothie Factory<Super>®</Super> PROTECT YOUR PERSONAL INFORMATION?
        </Title>
        <Text>
          Smoothie Factory<Super>®</Super> aspires to take reasonable measures to protect the personal information it
          ...
          information collected, used, stored or disclosed by Smoothie Factory<Super>®</Super>. For example, Smoothie
          Factory<Super>®</Super> uses Secure Sockets Layering (SSL) to encrypt your financial information, including
          your credit card number, before it travels over the Internet. SSL technology is the industry standard for
          secure online transactions.
        </Text>
        <Title>WHAT ABOUT LINKS TO OTHER WEB SITES?</Title>
        <Text>
          This Privacy Policy applies solely to information collected by Smoothie Factory<Super>®</Super>. However, our
          ...
          could be the case even for those web sites that carry Smoothie Factory<Super>®</Super>’s or its affiliates’
          trademarks or logos or which are framed by our Sites. Please be aware that Smoothie Factory<Super>®</Super> is
          not responsible for the data collection, use and disclosure practices of companies or organizations to which
          our Sites may provide links. We encourage our Users to be aware when they leave our Sites and to read the
        ...
        <Text>
          ...
          note that in most cases, Smoothie Factory<Super>®</Super> will retain the previously entered data, and may
          even be prohibited by law from expunging certain data from its systems.
        </Text>
        <Title>
          HOW DO I CONTACT Smoothie Factory<Super>®</Super> REGARDING THE SITE AND THIS PRIVACY POLICY?
        </Title>
        <Text>
