          ...
          <RelativeWrapper data-reverse-layout="true" mb="clamp(170px,36.97vw, 559px)">
            <GalleryContent data-reverse-layout="true">
              <GalleryContentWrapper>
                ...
                <GalleryText>
                  All-natural fresh-squeezed juices loaded with vitamins and minerals designed to cleanse and nourish
                  the body.
                </GalleryText>
                <GalleryButtons>
                  <a href="/SFK Menu Board_site.pdf" download>
            ...
            <GalleryContent data-reverse-layout="true">
              <GalleryContentWrapper>
                ...
                <GalleryText>
                  ...
                  combined to delight your senses. Our diverse range offers something for every palate. Elevate your
                  meals with these nutrient-rich creations that bring a burst of flavor and wholesome goodness to your
                  table.
                </GalleryText>
                <GalleryButtons>
                  <a href="/SFK Menu Board_site.pdf" download>
            ...
            <GalleryContent>
              ...
              <GalleryContentWrapper>
                ...
                <GalleryText>
                  ...
                  crafted to perfection, discover a variety of options that cater to your taste preferences, making
                  every meal a delightful adventure.
                </GalleryText>
                <GalleryButtons>
                  <a href="/SFK Menu Board_site.pdf" download>
                    <CtaButton>see our menu</CtaButton>
